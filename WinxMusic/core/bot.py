...
class WinxBot(Client):
    ...
    async def _set_default_commands(self):
        ...
        admin_commands = [
            ...
            BotCommand("cplay", "play di ch"),
            BotCommand("cskip", "skip lagu di ch"),
            BotCommand("cend", "stop lagu di ch"),
            BotCommand("cpause", "pause lagu di ch"),
            BotCommand("cresume", "lanjutin lagu dich"), 
